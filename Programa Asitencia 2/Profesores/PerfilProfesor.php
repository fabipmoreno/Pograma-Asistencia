...
<body>
    ...
    <div class="containerPerfil">
        ...
        if (!isset($_SESSION['usuario']) || $_SESSION['usuario'] !== 'profesor' || empty($_SESSION['datos_usuario'])) {
        ...
        $datosProfesor = $_SESSION['datos_usuario'];

        // Imprime los datos del alumno
        echo "<div class='containerPerfil datosUsuario'>";
        echo "<img src='{$datosProfesor['foto']}' alt='Foto de {$datosProfesor['Nombre']}' class='fotoProfesor'>";
        echo "<h2 class='titulo'>Perfil del Alumno</h2>";
        echo "<p>Nombre: {$datosProfesor['Nombre']}</p>";
        echo "<p>Apellidos: {$datosProfesor['Apellidos']}</p>";
        echo "<p>Correo: {$datosProfesor['Correo']}</p>";
        echo "</div>";
        ?>
